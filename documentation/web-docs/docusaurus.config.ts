...
const config: Config = {
  ...
  tagline: 'A drag and drop library that finally works on React Native',
  ...
  organizationName: 'entropyconquers', // Usually your GitHub org/user name.
  projectName: 'react-native-reanimated-dnd', // Usually your repo name.
