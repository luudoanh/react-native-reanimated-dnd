  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        "hooks/useHorizontalSortable",
        "hooks/useHorizontalSortableList",
      ],
    },
    {
      type: "category",
      label: "Context & Providers",
      items: ["context/DropProvider", "context/DragDropContext"],
    },
    {
      type: "category",
      label: "Examples",
  ...
  apiSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        "api/hooks/useHorizontalSortable",
        "api/hooks/useHorizontalSortableList",
      ],
    },
    {
      type: "category",
      label: "Context & Providers",
      items: ["api/context/DropProvider", "api/context/DragDropContext"],
    },
    {
      type: "category",
